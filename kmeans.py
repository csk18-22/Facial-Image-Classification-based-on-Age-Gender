...
def kmeans(d, m, f, k):  # d-data ,m-initial mean of the data,f-number of data items,k-K for K-means
    ...
    while 1:
        ...
        for cell in d:
            ...
            mini = 1000000
            for mean in m:
                # distance b/w current item and mean
                cur = np.linalg.norm(cell[:]-mean)
                # print cur,i
...
for filename in os.listdir(dirname):
    ...
    # size == size of the image file,will be used to initializing Array
...
# for training data 200 male and 200 female faces
maledata = np.zeros((200, size[0]*size[1]))
